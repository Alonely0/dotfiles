            ...
            PlasmaExtras.ScrollArea {
                ...
                GridView {
                    ...
                    delegate: ItemGridDelegate {
                        ...
                        width:  {
                            if (plasmoid.configuration.highlightSize == 0) {
                                cellWidth - units.smallSpacing * 8
                            } else if (plasmoid.configuration.highlightSize == 1) {
                                cellWidth - units.smallSpacing * 4
                            } else {
                                cellWidth
                            }
                           }
                        height: {
                            if (plasmoid.configuration.highlightSize == 0) {
                                cellHeight - units.smallSpacing * 8
                            } else if (plasmoid.configuration.highlightSize == 1) {
                                cellHeight - units.smallSpacing * 4
                            } else {
                                cellHeight
                            }
                           }
