# Generated by Powerlevel10k configuration wizard on 2021-04-09 at 20:34 CEST.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    workspace 		    # at workstation; on the go
    # =========================[ Line #2 ]=========================
    newline                 # \n
...
##################################[ dir: current directory ]##################################
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      # Separators
      local 	 white=$(tput sgr 0) # white foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=50
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=153

  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="'\033[31m%n \033[0mon \033[35m%m'"
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='\032[36m%n \033[0mon \033[35m%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='\033[36m%n \033[0mon \033[35m%m'
